...
public class calculator extends JFrame{
	...
	sub, mul, div, equals, clear, negative, decimal;
	...
	public calculator() {
		...
		ControlPanel.add(mul);ControlPanel.add(div);ControlPanel.add(clear);
		ControlPanel.add(decimal);ControlPanel.add(negative);ControlPanel.add(equals);
